...
function RXF4_Open_JobSelector(Parent)
	GAMEMODE.ConnectedPlayersPanel = vgui.Create("RXF4_M_JobSelector",Parent)
...
function PANEL:Install()
	...
	self.TopLabel.Paint = function(slf)
		...
		draw.SimpleText("Choose Job you want to be", "SansationOut_S40", 20,20, Color(0,255,255,255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end
...
vgui.Register("RXF4_M_JobSelector",PANEL,"DFrame")
