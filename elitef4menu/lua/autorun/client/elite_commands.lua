function LoadCommandPanel()
	...
	COMMAND_WINDOW.Paint = function( self, w, h )
		...
		draw.SimpleText( "Commandes", "RP_SubFontThick", 24, 20, Color( 190, 190, 190 ) )
