...
table.insert( sideButtons, { Title = "Acceuil", Func = function() LoadHomePanel() end } )
table.insert( sideButtons, { Title = "Commandes", Func = function() LoadCommandPanel() end } )
table.insert( sideButtons, { Title = "Emplois", Func = function() LoadCmdPanel() end } )
table.insert( sideButtons, { Title = "Armes", Func = function() OpenWeaponsTab() end } )
table.insert( sideButtons, { Title = "Objets", Func = function() LoadEntitiesPanel() end } )
table.insert( sideButtons, { Title = "Munnitions", Func = function() LoadAmmoPanel() end } )

if ELITE.ShowFoodTab then
	table.insert( sideButtons, { Title = "Nourriture", Func = function() LoadFoodPanel() end } )
end

table.insert( sideButtons, { Title = "Site Web", Func = function()
