function LoadHomePanel()
	...
	HOME_STATS.Paint = function( self, w, h )
		...
		draw.SimpleText( maxPlayers.." Joueur Actifs", "RP_SubFontThick", 92, 77, Color( 0, 0, 0 ) )
		...
		draw.SimpleText( "Economie", "RP_CatFont", 30, 143, Color( 255, 255, 255 ) )
		...
		draw.SimpleText( "$"..tMoney.." Actif Sur le Serveur", "RP_SubFontThick", 92, 137, Color( 0, 0, 0 ) )
		draw.SimpleText( "$"..highMoney.." Joueur Le Plus Riche - "..string.upper(first.ply:Nick()), "RP_SubFontThick", 92, 154, Color( 190, 190, 190 ) )
		
		surface.SetDrawColor( Color( 211, 84, 0 ) )
		surface.SetMaterial( Material( "elitef4menu/ribbon.png" ) )
		surface.DrawTexturedRect( 24, 200, 60, 18 )
		
		draw.SimpleText( "Emplois", "RP_CatFont", 30, 203, Color( 255, 255, 255 ) )
		
		draw.SimpleText( table.Count( jobs ).." Emplois Utulisés", "RP_SubFontThick", 92, 197, Color( 0, 0, 0 ) )
		draw.SimpleText( "Emploi Le Plus Populaire - "..string.upper(team.GetName( table.GetWinningKey( teamTable ) )).." ("..team.NumPlayers(table.GetWinningKey( teamTable )).." PLAYERS)", "RP_SubFontThick", 92, 197 + 17, Color( 190, 190, 190 ) )
	...
	HOME_INFO.Paint = function( self, w, h )
		...
		draw.SimpleText( "Graphique Des Emplois", "RP_SubFontThick", 24, 20, Color( 190, 190, 190 ) )
