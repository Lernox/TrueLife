...
RP_MySQLConfig.Host = "192.168.1.40" -- This is the IP address of the MySQL host. Make sure the IP address is correct and in quotation marks (" ")
...
RP_MySQLConfig.Password = "Lernox453" -- This is the Password to log in on the MySQL server,
